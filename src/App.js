...
function App() {
  ...
  return (
    <>
      {done ? <div className="animation-cont"><ReactLoading type={'bars'} color={'#fd8c22'} /></div>
        :
          ...
          <div className="main-container">
                ...
                <Row>
                  <div className="projects-wrapper pb-5">
                    <div className="project-blocks">
                      <div data-aos="fade-right" className='px-5 py-4 md:py-6'>
                      ...
                      <div data-aos="fade-right" data-aos-offset="200" className='px-5 py-4 md:py-6'>
                      ...
                      <div data-aos="fade-left" data-aos-offset="200" className='px-5 py-4 md:py-6'>
            ...
            <section id='services'>
              <Container>
                ...
                <Row className='row-m'>
                  <Col lg={6} md={6} sm={12}>
                    <div data-aos="fade-right" data-aos-offset="200" className="services">
                      <div>
                        <FaDesktop />
                      </div>
                  ...
                  <Col lg={6} md={6} sm={12}>
                    <div data-aos="fade-left" data-aos-offset="200" className="services res-mt">
                      <div>
                        <BiMobileAlt />
                      </div>
              ...
              <Container>
                <Row className='row-m'>
                  <Col lg={6} md={12} sm={12}>
                    <div data-aos="fade-right" data-aos-offset="200" className="want-to-hire-me">
                  ...
                  <Col lg={6} md={12} sm={12}>
                    <div data-aos="fade-left" data-aos-offset="200" className="call-me">
                      <p>+92-321-8961570</p>
                ...
                <Row>
                  <Col lg={12} md={12} sm={12}>
                    <div className={`${darkMode ? 'footer-dark' : 'footer-light'}`}>
                      <p data-aos="fade-right" data-aos-offset="10">Made by <span className='heart'>&hearts;</span></p>
                    </div>
                  </Col>
                </Row>
              </Container>
